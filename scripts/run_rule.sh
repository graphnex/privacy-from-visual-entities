...
#
# Number to repeat results (seed), default: 789
# SEED=
#
today=`date +%Y%m%d`
#
...
MODEL_NAME=personrule       # ga_mlp, gpa-rev
MODEL_NAME_B=personrule    # ga_mlp, gpa_rev
...
for R in {0..1} # run/repetition
do

for M in 1 2
do

CONFIG_FILE=$ROOT_DIR/configs/${MODEL_NAME}_v${M}.json

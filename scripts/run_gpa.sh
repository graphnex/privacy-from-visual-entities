...
MODEL_NAME=gpa       # ga_mlp, gpa-rev
MODEL_NAME_B=gpa    # ga_mlp, gpa_rev
...
for M in 8 0 1 2 3 4 5 6 7 #  mode
do

CONFIG_FILE=$ROOT_DIR/configs/${MODEL_NAME}_v1.$M.json

myzipfile=${today}__${MODEL_NAME}_${DATASET}_v${M}.0.${R}.zip
...
echo "GPA model and results backed up!"